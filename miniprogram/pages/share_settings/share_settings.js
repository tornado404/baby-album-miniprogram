...
Page({
    ...
    applyI18n: function () {
        this.setData({
            i18n: {
                title: (0, i18n_1.t)('share.title'),
                emptyList: (0, i18n_1.t)('share.emptyList'),
                emptyHint: (0, i18n_1.t)('share.emptyHint'),
                inviteFamily: (0, i18n_1.t)('share.inviteFamily'),
                viewer: (0, i18n_1.t)('share.viewer'),
                editor: (0, i18n_1.t)('share.editor'),
                revoke: (0, i18n_1.t)('share.revoke'),
                createInvite: (0, i18n_1.t)('share.createInvite'),
                selectBaby: (0, i18n_1.t)('share.selectBaby'),
                permission: (0, i18n_1.t)('share.permission'),
                inviteCode: (0, i18n_1.t)('share.inviteCode'),
                copy: (0, i18n_1.t)('share.copy'),
                cancel: (0, i18n_1.t)('common.cancel'),
            },
        });
    },
    getToken: function () {
    ...
    loadShareList: function () {
        ...
        var token = this.getToken();
        wx.request({
            url: api_1.API_CONFIG.baseURL + '/share/relations',
            method: 'GET',
            header: { 'Authorization': 'Bearer ' + token },
            timeout: 8000,
            success: function (res) {
    ...
    onCreateInvite: function () {
        ...
        wx.request({
            url: api_1.API_CONFIG.baseURL + '/share/invitations',
            method: 'POST',
    ...
    onRevokeTap: function (e) {
        ...
        wx.showModal({
            ...
            success: function (res) {
                if (res.confirm) {
                    wx.request({
                        url: api_1.API_CONFIG.baseURL + '/share/relations/' + relationId,
                        method: 'DELETE',
                        header: { 'Authorization': 'Bearer ' + token },
                        timeout: 8000,
