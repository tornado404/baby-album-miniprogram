 ...
 * @returns 压缩后的临时文件路径
 */
function compressImage(filePath_1) {
    return __awaiter(this, arguments, void 0, function (filePath, quality, targetWidth) {
        if (quality === void 0) { quality = 80; }
        if (targetWidth === void 0) { targetWidth = 1920; }
...
function chooseMedia() {
    return __awaiter(this, arguments, void 0, function (count, mediaType) {
