    ...
    methods: {
        ...
        onSaveAll: function () {
            ...
            this.triggerEvent('saveAll', {
                items: this.properties.fileList.map(function (_, i) { return ({
                    index: i,
                    data: {
                        locationName: _this_1.data.locationName,
                        tags: _this_1.data.tags,
                        moment: _this_1.data.moment,
                        milestone: _this_1.data.milestone,
                    },
                }); }),
            });
